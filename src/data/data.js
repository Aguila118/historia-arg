export const datos = [ 
...

  {
    ...
    'birth':'(03/06/1770)-(20/06/1820)', 
    'baseBio':'Abogado, economista, político y militar.',
    ...
    'bio1': 'Participó en la defensa de Buenos Aires, capital del Virreinato del Río de la Plata, en las dos Invasiones Inglesas —1806 y 1807— y promovió la emancipación de Hispanoamérica respecto de España en apoyo a las aspiraciones de la princesa Carlota Joaquina en la región, aunque sin éxito. Fue uno de los principales patriotas que impulsaron la Revolución de Mayo, por la cual se destituyó al virrey Baltasar Hidalgo de Cisneros, y fue vocal de la Primera Junta de gobierno que lo reemplazó.',
    'bio2': 'Luchó en la guerra de Independencia de la Argentina contra los ejércitos realistas. Fue el jefe de la expedición militar que la junta de Buenos Aires envió al Paraguay que finalizó cuando celebró el Tratado confederal entre las juntas de Asunción y Buenos Aires, en 1811. Fue jefe de una de las Expediciones Libertadoras a la Banda Oriental.',
    'bio3': 'En 1812 creó​ la bandera de Argentina en la actual ciudad de Rosario.',
    'bio4': 'Durante el Directorio tuvo gran influencia en el Congreso de Tucumán que declaró la Independencia de las Provincias Unidas en Sud América, en 1816, proyectó en vano el establecimiento de una monarquía constitucional dirigida por un noble Inca. Comandó las tropas nacionales que participaron en la guerra civil contra los caudillos del litoral.'
  },

  {
    ...
    'birth':'(08/02/1785)-(17/06/1821)', 
    'baseBio':'Caudillo, Militar y Político.',
    'bio': 'Martín Miguel Juan de Mata Güemes Montero de Goyechea y la Corte (Salta, Virreinato del Río de la Plata, 8 de febrero de 1785 - Cañada de la Horqueta, Salta, 17 de junio de 1821), conocido como Martín Miguel de Güemes, fue un militar y político argentino que cumplió una destacada actuación en la Guerra de Independencia de la Argentina.1​ Durante seis años fue gobernador de Salta.​ Con muy escasos recursos libró una constante guerra de guerrilla, conocida como Guerra Gaucha, deteniendo seis invasiones del ejército español, conservando así el resto del actual territorio argentino libre de invasores realistas.',
    'bio1': '',
    'bio2': '',
    'bio3': '',
    'bio4': ''
...

  {
    'id': 'hecho',
    'name': 'RevolucionMayo',
    'fullName':'Revolucion de Mayo', 
    'birth':'semana de mayo (25/05/1810)', 
    'baseBio':'Semana de acontecimientos revolucionarios y la posterior formacion del 1er Triunvirato.',
    'bio': 'La Revolución de Mayo fue una serie de acontecimientos revolucionarios ocurridos en la ciudad de Buenos Aires, capital del Virreinato del Río de la Plata, dependiente del rey de España, que sucedieron durante el transcurso de la llamada Semana de Mayo, entre el 18 de mayo de 1810, fecha de la confirmación oficial de la caída de la Junta Suprema Central, y el 25 de mayo, fecha en que se destituyó al virrey Baltasar Hidalgo de Cisneros y se lo reemplazó por la Primera Junta de gobierno.',
    'bio1': 'Si bien inició el proceso de surgimiento del Estado argentino no hubo una proclamación de la independencia formal, ya que la Primera Junta no reconocía la autoridad del Consejo de Regencia de España e Indias, pero aún gobernaba nominalmente en nombre del rey de España Fernando VII, quien había sido depuesto por las Abdicaciones de Bayona y su lugar ocupado por el francés José Bonaparte.',
    'bio2': 'Esta manifestación de lealtad, conocida como la máscara de Fernando VII, es considerada por algunos historiadores como una maniobra política que ocultaba las intenciones independentistas.',
    'bio3': '',
    'bio4': ''
  },
